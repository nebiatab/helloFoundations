...
class MyInventory
{
    public static void Main()
    {
        ...
        int ItemDBSize = 0;
        ItemData[] itemData = new ItemData[1];  // create an array of your ItemData struct
                ...
                case 1: // add an item to the list if this option is selected
                    {
                        ...
                        {
                            //put things into each item of the array with this foreach loop?
                            // Console.WriteLine("");
                        }*/
                        break;
                    }
                ...
                case 3: //delete items in the list if this option is selected
                    {
                        ...
                        for (int x = 0; x < itemData.Length; x++)
                        {
                            ...
                            //        int n = itemData.Length - 1;             // create a new array with one less length
                            //        ItemData[] newitemData = new ItemData[n];
                            //       itemData.CopyTo(newitemData, 0); // copy the old into the new 
                            //       itemData = newitemData; // delete the old array
                        }
